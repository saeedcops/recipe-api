...
class PrivateRecipesApiTests(TestCase):
    ...
    def test_full_update_recipe(self):
        ...
        recipe = sample_recipe(user=self.user)
        recipe.tags.add(sample_tag(user=self.user))
        payload = {'title': 'Spaghetti', 'time_minutes': 5, 'price': 5.00}
        url = detail_url(recipe.id)
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        """Test running recipe with specific tags"""
    ...
    def test_filter_recipes_by_ingredients(self):
        """Test running recipe with specific ingredients"""
        recipe1 = sample_recipe(user=self.user, title='Posh beans')
        recipe2 = sample_recipe(user=self.user, title='Chechen')
        ingredient1 = sample_ingredient(user=self.user, name='Feta cheese')
        ingredient2 = sample_ingredient(user=self.user, name='Cecken')
